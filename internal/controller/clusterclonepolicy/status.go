...
func (r *ClusterClonePolicyReconciler) UpdateConditionSuccess(cPolicy *v1alpha1.ClusterClonePolicy) {
...
func (r *ClusterClonePolicyReconciler) UpdateConditionKubernetesApiCallFailure(cPolicy *v1alpha1.ClusterClonePolicy) {
